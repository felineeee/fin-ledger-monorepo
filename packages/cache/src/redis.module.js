...
var redis_constants_js_1 = require("./redis.constants.js");
var RedisModule = function () {
            ...
            providers: [
                {
                    ...
                    useFactory: function (configService) {
                        var redisUrl = configService.get('REDIS_URL', 'redis://localhost:6379');
    ...
    var RedisModule = _classThis = /** @class */ (function () {
        function RedisModule_1(redisClient) {
            this.redisClient = redisClient;
        }
        RedisModule_1.prototype.onModuleInit = function () {
        ...
        RedisModule_1.prototype.onApplicationShutdown = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!this.redisClient.isOpen) return [3 /*break*/, 2];
